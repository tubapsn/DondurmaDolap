                          ...
                          <table class="table table-striped table-bordered table-advance table-hover">
                              <thead>
                                <tr>
                                    ...
                                    <th class="hidden-phone"><i class="icon-inbox"></i> Dış Sıcaklık</th>
                              ...
                              <tbody>
                                <?php
                                  foreach ($cihazlar as $cihaz) {
                                    ...
                                    echo '<td class="hidden-phone"><strong>Cihaz ID:</strong> #' . $cihaz->id . ", <strong>Dış Sıcaklık:</strong> " . $cihaz->dis_sicaklik . '</td>';
