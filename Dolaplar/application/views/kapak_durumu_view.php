                          ...
                          <table class="table table-striped table-bordered table-advance table-hover">
                              <thead>
                                <tr>
                                    ...
                                    <th class="hidden-phone"><i class="icon-inbox"></i> Kapak Durumu</th>
                              ...
                              <tbody>
                                <?php
                                  foreach ($cihazlar as $cihaz) {
                                    ...
                                    echo '<td class="hidden-phone"><strong>Cihaz ID:</strong> #' . $cihaz->id . ", <strong>Kapak Durumu:</strong> " . ($cihaz->kapak_durumu == 1 ? "Kapalı" : "Açık") . '</td>';
