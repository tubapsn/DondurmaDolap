          ...
          <div id="sidebar" class="nav-collapse collapse">
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          <li class="active"><a class="" href="general.html">Bildirimler</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a href="icsicaklik.html" class="">İç Sıcaklık</a></li>
                            ...
                            <div class="widget-body">
                                <table class="table table-striped table-bordered table-advance table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th><i class="icon-bookmark"></i> Dış Sıcaklık</th>
                                    ...
                                    <tbody>
                                     <?php
                                        $query = $connectDatabase->query("SELECT m.market_adi, c.tarih, c.dis_sicaklik FROM marketler m INNER JOIN cihazlar c ON m.market_id=c.market_id WHERE dis_sicaklik <= 19 OR dis_sicaklik >= 34 ORDER BY market_adi ", PDO::FETCH_ASSOC);
                                        if ( $query->rowCount() ){
                                            foreach( $query as $row ){
                                                ?>
                                                <tr>
                                                <td><a href="dolapdetay.html"><?php  print $row['market_adi'] ?></a></td>
                                                <td class="hidden-phone"><?php  print $row['dis_sicaklik'] ?></td>
