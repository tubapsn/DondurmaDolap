                    ...
                    <div class="span12">
                        ...
                        <div class="widget orange">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i> Kapak Durumu</h4>
                                <span class="tools">
                                ...
                                <table class="table table-striped table-bordered table-advance table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><i class="icon-bookmark"></i> Kapak Durumu</th>
                                    ...
                                    <tbody>
                                        <?php
                                        $query = $connectDatabase->query("SELECT m.market_adi, c.tarih FROM marketler m INNER JOIN cihazlar c ON m.market_id=c.market_id WHERE kapak_durumu=1 ORDER BY market_adi", PDO::FETCH_ASSOC);
                                        if ( $query->rowCount() ){
                                            foreach( $query as $row ){
                                                ?>
                                                <tr>
                                                <td><a href="dolapdetay.html"><?php  print $row['market_adi'] ?></a></td>
                                                <td class="hidden-phone">Açık</td>
